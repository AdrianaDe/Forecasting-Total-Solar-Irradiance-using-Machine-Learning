...
savingpath = path = os.path.join(os.path.dirname(__file__), '../Results/XGBoost/')  # CHANGE SAVINGPATH
...
################# TUNING ############################
#####################################################
find_best_hyperparameters(hyperparameters, names, xgboost, start_year, n_pred, n_iterations, optimizing_i=0, savingpath=savingpath, scaler=series.scaler, method='data_all_model_random')  # method = 'random'
