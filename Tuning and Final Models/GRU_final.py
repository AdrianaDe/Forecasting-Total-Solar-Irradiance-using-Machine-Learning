...
savingpath = '/cluster/home/adesassi/Final/GRU/'  # !!!
# savingpath = savingpath = '/content/drive/MyDrive/Colab Notebooks/0818/'
...
print()
print('*'*30)
print('IMF0 backtesting')
print('mse direct predict:', imf0_reconstructed.mse(historical_forecasts0))
print('*'*30)
...
print()
print('*'*30)
print('IMF1 backtesting')
print('mse direct predict:', imf1_reconstructed.mse(historical_forecasts1))
print('*'*30)
...
print()
print('*'*30)
print('IMF0 + IMF1 backtesting')
print('mse compared to real imf 0 + imf1:', imf01_reconstructed.mse(historical_forecasts01))
print('mse compared to observed data:', total_reconstructed.mse(historical_forecasts01))
print('*'*30)
...
plot_with_interval(imf0_reconstructed, prediction0, names=['reconstructed_tsi'], variance=None, reference_series=None, addition='IMF0 ', savingpath=savingpath+'direct_')
plot_with_interval(imf0_tsi, prediction_transfer0, names=['tsi'], variance=None, reference_series=None, addition='IMF0 ', savingpath=savingpath+'direct_')
...
plot_with_interval(imf1_reconstructed, prediction1, names=['reconstructed_tsi'], variance=None, reference_series=None, addition='IMF1 ', savingpath=savingpath+'direct_')
plot_with_interval(imf1_tsi, prediction_transfer1, names=['tsi'], variance=None, reference_series=None, addition='IMF1 ', savingpath=savingpath+'direct_')
...
mean0, lower_bounds0, upper_bounds0, mean_transfer0, lower_bounds_transfer0, upper_bounds_transfer0 = block_bootstrap_(
    ...
    x_transfer= imf0_tsi, savingpath=savingpath+'IMF0_'
)
...
print('*'*30)
print('IMF0')
print('NRL mse direct predict:', imf0_reconstructed.mse(prediction0))
print('NRL mse mean predict:', imf0_reconstructed.mse(mean0))
print('PMOD mse direct predict:', imf0_tsi.mse(prediction_transfer0))
print('PMOD mse mean predict:', imf0_tsi.mse(mean_transfer0))
print('*'*30)
...
mean1, lower_bounds1, upper_bounds1, mean_transfer1, lower_bounds_transfer1, upper_bounds_transfer1 = block_bootstrap_(
    ...
    x_transfer=imf1_tsi, savingpath=savingpath+'IMF1_'
)
...
print('*'*30)
print('IMF1')
print('NRL mse direct predict:', imf1_reconstructed.mse(prediction1))
print('NLR mse mean predict:', imf1_reconstructed.mse(mean1))
print('PMOD mse direct predict:', imf1_tsi.mse(prediction_transfer1))
print('PMOD mse mean predict:', imf1_tsi.mse(mean_transfer1))
print('*'*30)
...
print()
print('*'*30)
print('total compared to original')
print('NRL mse direct predict:', total_reconstructed.mse(prediction01))
print('NRL mse mean predict:', total_reconstructed.mse(mean01))
print('PMOD mse direct predict:', total_tsi.mse(prediction_transfer01))
print('PMOD mse mean predict:', total_tsi.mse(mean_transfer01))
print('total compared to IMF0+IMF1')
print('NRL direct predict:', imf01_reconstructed.mse(prediction01))
print('NRL mean predict:', imf01_reconstructed.mse(mean01))
print('PMOD direct predict:', imf01_tsi.mse(prediction_transfer01))
print('PMOD mean predict:', imf01_tsi.mse(mean_transfer01))
print('*'*30)
